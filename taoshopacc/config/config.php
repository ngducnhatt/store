...
session_start();
$base_url = 'http://dailyhost.link/'; // Thay url web bạn
class CMSNT
{
    private $ketnoi;
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'h261694430417_shop', 'h261694430417_shop', 'h261694430417_shop') or die ('Vui lòng kết nối đến DATABASE');
