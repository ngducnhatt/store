...
$partner_id_card24 = '';
$partner_key_card24 = '';
function card24h($loaithe, $pin, $seri, $menhgia, $code){
    global $partner_key_card24, $partner_id_card24;
    $url = base64_decode('aHR0cHM6Ly9jYXJkMjRoLmNvbS9jaGFyZ2luZ3dzL3YyP3NpZ249').md5($partner_key_card24.$pin.$seri).'&telco='.$loaithe.'&code='.$pin.'&serial='.$seri.'&amount='.$menhgia.'&request_id='.$code.'&partner_id='.$partner_id_card24.'&command=charging';
    $ch = curl_init();
